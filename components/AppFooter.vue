      ...
      <div class="grid md:grid-cols-4 gap-8">
        <div class="md:col-span-2 lg:col-span-1">
          <div class="flex items-center space-x-3 mb-4">
            <h3 class="text-lg font-bold">เกี่ยวกับเรา</h3>
          </div>
        ...
        <div class="grid md:grid-cols-2 lg:col-span-3 gap-8 md:gap-16">
          <div>
          ...
          <div id="contact">
            ...
            <div class="space-y-3 text-sm">
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-gray-400">จังหวัดเชียงราย และเครือข่ายจังหวัดในภาคเหนือ</span>
              </div>
            </div>
          </div>
        </div>
