  ...
  <div v-for="device in filteredDevices" :key="device.dvid"
    ...
    <div class="flex justify-between items-start">
      <div class="flex items-center">
        <div class="bg-red-500 text-white rounded-full w-24 h-24 flex flex-col items-center justify-center">
          <div class="text-sm">Avg. Now</div>
          <div class="text-4xl font-bold">{{ device.avgNow }}</div>
          <div class="text-xs">µg/m³</div>
